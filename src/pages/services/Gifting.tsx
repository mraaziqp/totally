    ...
    <div className="min-h-screen bg-slate-50">
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <span className="text-2xl font-black text-rose-500 underline decoration-rose-200 decoration-4 underline-offset-4">TotalLŸ</span>
              <span className="text-xs font-semibold uppercase tracking-widest text-slate-400 border-l border-slate-200 pl-2">Gifting</span>
            </div>
          </div>
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-600">
            <a href="#about" className="hover:text-rose-600 transition-colors">Our Studio</a>
            <a href="#inquiry" className="bg-rose-500 text-white px-6 py-2 rounded-full hover:bg-rose-600 transition-colors shadow-sm shadow-rose-500/20">Send Inquiry</a>
          </div>
        </div>
      </nav>
      ...
      <section className="relative pt-24 pb-32 px-6 bg-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-1.5 mb-8 text-xs font-bold uppercase tracking-wider text-rose-600 bg-rose-50 rounded-full shadow-sm shadow-rose-500/5">
              <Scissors size={14} /> {storeData?.tagline || "Bespoke Craftsmanship"}
            </div>
            <h1 className="text-5xl md:text-8xl font-bold text-slate-900 leading-tight mb-8 tracking-tighter">
               {storeData?.heroHeadline || "PersonaLŸised Gifting Studio"}
            </h1>
            
            <div className="relative p-10 bg-white/40 backdrop-blur-md border border-rose-100 rounded-[3rem] shadow-sm">
              ...
              <Heart className="absolute -bottom-6 -right-6 text-rose-200" size={64} fill="currentColor" />
            </div>

            <div className="mt-12 flex flex-col sm:flex-row gap-10">
               <div className="flex items-center gap-5">
                  <div className="w-14 h-14 rounded-full bg-rose-100 flex items-center justify-center text-rose-600 shadow-sm shadow-rose-500/10">
                    <Phone size={24} />
                  </div>
                  <div>
                    <p className="text-xs uppercase font-bold text-slate-400 tracking-widest">Studio Line</p>
                    <p className="text-xl font-bold text-slate-800">{storeData?.contactPhone || "[Insert Phone Number]"}</p>
                  </div>
               </div>
               <div className="flex items-center gap-5">
                  <div className="w-14 h-14 rounded-full bg-rose-100 flex items-center justify-center text-rose-600 shadow-sm shadow-rose-500/10">
                  ...
                  <div>
                    <p className="text-xs uppercase font-bold text-slate-400 tracking-widest">Bulk Inquiries</p>
                    <p className="text-xl font-bold text-slate-800">{storeData?.contactEmail || "info@totally.co.za"}</p>
                  </div>
               </div>
            </div>
          </motion.div>
      ...
      <section className="py-24 px-6 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-500 max-w-xl mx-auto text-lg leading-relaxed">High-quality products designed to carry your brand or personality with elegance.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {categories.map((cat, idx) => (
              <motion.div
                ...
                className="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-500 text-center flex flex-col items-center"
              >
      ...
      {/* Origin Story & Values (Brief) */}
      <section id="about" className="py-24 px-6 bg-white overflow-hidden relative">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="relative">
             <h2 className="text-5xl md:text-6xl font-bold text-slate-900 mb-8 leading-tight tracking-tighter">
      ...
      <footer className="bg-slate-900 text-slate-400 py-16 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 text-sm text-center md:text-left">
           <div>
