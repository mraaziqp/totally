        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <span className="text-lg sm:text-2xl font-black text-teal-500">TotalLŸ</span>
              <span className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 border-l border-slate-200 pl-2 hidden xs:block">High Pressure</span>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <a href="#services" className="hidden md:block text-sm font-medium text-slate-600 hover:text-teal-600 transition-colors">Services</a>
            <a href="#booking" className="bg-teal-500 text-white px-4 py-2 text-sm rounded-full hover:bg-teal-600 transition-colors shadow-sm shadow-teal-500/20 font-semibold">Book Now</a>
          </div>
        </div>
      </nav>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start relative z-10">
          ...
          >
            ...
            <div className="relative p-6 bg-white/60 backdrop-blur-sm border border-slate-100 rounded-2xl text-slate-700 italic leading-relaxed text-base sm:text-lg shadow-sm">
               <Waves className="absolute -top-3 -left-3 text-teal-400" size={28} />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8">
            {services.map((item, index) => (
              <motion.div 
                ...
                className="bg-white p-6 sm:p-10 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow group flex gap-4 sm:gap-6"
              >
