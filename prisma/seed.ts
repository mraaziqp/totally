...
async function main() {
  ...
  const deepCleaning = await prisma.store.create({
    data: {
      ...
      heroHeadline: 'CleanDeep - Deep Soft Cleaning',
      ...
      aboutUsText: 'CleanDeep was born from the vision of young entrepreneurs who wanted to redefine service excellence in South Africa. Guided by our Islamic school mentor, we embarked on this journey with a commitment to something deeper than just cleaning.\n\nAt the heart of everything we do are the values of honesty, fairness, trust, and ihsaan (excellence). We believe that being thorough in our work is an act of integrity, and we treat every home and office with the same respect we would our own.',
      testimonialText: 'The CleanDeep team brings a level of professionalism and efficiency that is rare. Their commitment to ihsaan is visible in every corner they clean.',
      testimonialAuthor: 'Moulana Luqmaan',
      testimonialAuthorRole: 'Community Leader',
      address: '2 Second Street Maitland',
      instagramUrl: 'https://www.instagram.com/cleandeep_cpt1?igsh=MWE4a2h4bDlwMXdvOQ%3D%3D&utm_source=qr',
      facebookUrl: 'https://www.facebook.com/share/1E9N7NCcUe/?mibextid=wwXIfr',
      tiktokUrl: 'https://www.tiktok.com/@cleandeep_cpt1?is_from_webapp=1&sender_device=pc',
      galleryImages: [
  ...
  const pressureCleaning = await prisma.store.create({
    data: {
      ...
      address: '2 Second Street Maitland',
      instagramUrl: 'https://www.instagram.com/cleandeep_cpt1',
      facebookUrl: 'https://www.facebook.com/cleandeep',
      tiktokUrl: 'https://www.tiktok.com/@cleandeep_cpt1',
      galleryImages: [
